...
/* jQuery(function ($) {
    $(document).on('submit', '#searchForm', function (e) {
        ...
        e.preventDefault();
        $.ajax({
            url: 'http://localhost:8080/Medical/services/search/salt/'+inputVal,
            type: 'get',
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" type="button"> <span
							...
							style="width: 24px; height: 24px; margin-top: 0px;"><strong><sec:authentication property="principal.Username" /></strong> <span class="glyphicon glyphicon-chevron-down"></span>
					</a>
								...
								<div class="navbar-login">
									<div class="row">
										...
										<div class="col-lg-8">
											...
											<p class="text-left small" style="color: #444;"><sec:authentication property="principal.Username" /></p>
											<p class="text-left">
	...
	<section class="container-fluid" id="section3">
		...
		<div class="row">
			<div class="col-sm-6 col-lg-offset-3">
				...
				<br>
				<p class="lead text-center">Everyday, we work on problems no
					one has dared to solve before. We’re dreamers, thinkers and
					do-ers all rolled into one. We have audaciously, galactically big
					dreams - because that’s what it takes to truly change the world
					and improve healthcare access for humanity.</p>
				<br>
				<p class="text-center">
